...
import TimerIcon from '@/entities/WithdrawCalculator/assets/icons/timer.svg';
...
export const FundWithdrawReceive = memo(() => {
  const { vaultPrice, isLoadingVaultPrice, timer } = useFundWithdrawContext();
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          >
            ...
            <Skeleton
              isLoaded={!isLoadingVaultPrice}
              className="rounded-lg dark:bg-background-tableRow"
            >
              ${formatUserMoney(vaultPrice)}
            </Skeleton>
          </Text>
        </div>
      </div>
