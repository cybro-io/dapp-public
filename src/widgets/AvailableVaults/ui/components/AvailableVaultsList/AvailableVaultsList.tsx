...
import { Dropdown, DropdownView, Text, TextView } from '@/shared/ui';
...
> = ({ vaults, sort, setSort, skeletons, isLoading, className }) => {
  ...
  const handleDropdownSort = React.useCallback(
    (sortName: SortValue, event: React.SyntheticEvent) => {
        ...
        <div className={styles.table}>
          <div className={styles.mobileSort}>
            ...
            <Dropdown
              ...
              selectedTitle={headers.find(({ key }) => sort[0] === key)?.label}
              selectedKey={sort[0]}
