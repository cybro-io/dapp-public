  ...
  return (
    <Stack className="gap-6 md:gap-8 items-center px-6">
      <Stack className="gap-3 md:gap-4 items-center">
        ...
        >
          Explore our top-performing vaults and one-click investment options.
          With AI-powered management and optimized yields, these hand-picked
          selections are designed to suit different risk profiles and investment
          goals.
        </Typography>
      </Stack>
