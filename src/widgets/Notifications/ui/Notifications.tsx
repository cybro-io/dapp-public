...
import { ManageNotifications } from '@/features/ManageNotifications';
      ...
      {isOpen && (
        <Modal
          ...
          classNames={{
            ...
            base: 'self-start top-[81px] lg2:top-[109px] lg2:min-h-[calc(100%-109px)] min-h-[calc(100%-81px)] !rounded-b-none',
          }}
        >
          {isOpenManage ? (
