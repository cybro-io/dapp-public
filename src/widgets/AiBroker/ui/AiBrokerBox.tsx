...
export const AiBrokerBox = ({
  ...
  return (
    <Stack
      className={twMerge(
        'overflow-hidden relative w-full md:w-[700px] h-fit md:h-[calc(100vh-71px-50px-50px-32px-34px)] max-h-[726px] min-h-[550px] rounded-none md:rounded-[30px] bg-[rgba(17,18,26,0.01)] backdrop-blur-[50px] border border-solid border-white/10',
        className,
      )}
    >
      <div className="w-[569px] h-[579px] left-[-100px] md:left-[65.5px] bottom-[-310px] md:bottom-[-289px] absolute z-[-1]">
        <div
          className={clsx(
            bg.first,
            'w-[569px] h-[579px] left-0 top-0 absolute opacity-30 rounded-full blur-[192.72px]',
          )}
        />
        <div
          className={clsx(
            bg.second,
            'w-[408.05px] h-[194.58px] left-[80.47px] top-[192.92px] absolute rounded-full blur-[129.76px]',
          )}
        />
      </div>
      {children}
